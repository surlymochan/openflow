...
const DIMENSIONS = [
  ...
  },
  {
    ...
    evidence: [
      ...
      ['text', 'xflow/atoms/j4c_openspec_migration_map.py', /OpenSpec project to openflow surfaces/],
    ],
  },
  {
  ...
  },
  {
    ...
    evidence: [
      ...
      ['file', 'docs/adoption/openflow-release-hardening.md'],
      ...
      ['text', 'docs/adoption/openflow-release-hardening.md', /xflow launch audit --strict --json/],
  ...
  },
  {
    ...
    evidence: [
      ...
      ['file', 'docs/public-benchmark.md'],
      ['file', 'docs/npm-publish-handoff.md'],
      ['text', 'docs/install-upgrade.md', /npm install -g openflow/],
